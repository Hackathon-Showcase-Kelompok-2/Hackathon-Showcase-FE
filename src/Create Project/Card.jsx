...
const CardProjects = () => {
  return (
    <div className="flex items-center  justify-center bg-gray-100 py-4 px-4 min-w-screen  ">
      <div className="bg-blue-50 rounded-2xl p-10 flex flex-col items-center relative overflow-hidden w-full">
        ...
        <h1 className="text-3xl font-bold text-center text-black z-10">
          Event Galeri Hackathon
        </h1>
        <p className="text-center text-gray-600 mt-6 z-10 leading-relaxed">
        Jelajahi berbagai acara hackathon dari seluruh dunia. Pilih tema yang  
          <br />
          Anda suka dan mulai inovasi Anda sekarang!
        </p>
      </div>
    </div>
  );
