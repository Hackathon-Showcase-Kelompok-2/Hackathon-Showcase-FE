            ...
            <Link to={`/project/${project.id}`} key={project.id}>
              <div className="bg-white rounded-lg shadow-md p-6">
                <img
                  ...
                  className="rounded-lg mb-4 w-full"
                  src={project.img_project || "/default_image_path.png"} // Fallback if no image is provided
                />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <img
                      alt={`${project.user_name || "User"}'s profile picture`}
                      className="w-10 h-10 rounded-full mr-2"
                      src={project.user_image || "/default_user_image.png"} // Fallback for user image
                    />
                    <p className="font-medium">{project.user_name || "Unknown"}</p>
                  </div>
                  <div className="flex text-gray-500">
                    <span className="mr-4">
                      <i className="fas fa-heart"> </i> {project.likes || 0}
                    </span>
                    <span className="mr-4">
                      <i className="fas fa-comment"> </i> {project.comments || 0}
                    </span>
                    <span>
                      <i className="fas fa-eye"> </i> {project.views || 0}
                    </span>
                  </div>
                </div>
              </div>
