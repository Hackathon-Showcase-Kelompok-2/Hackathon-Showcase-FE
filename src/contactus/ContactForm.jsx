...
function ContactForm() {
  ...
  return (
    <div className="flex items-center justify-center p-8 bg-gray-100 shadow-lg w-[1372px] h-[750px]">
      <div className="w-1/2">
        ...
        <p className="mb-4 text-lg text-black">
          ...
          hari ini dan buktikan kemampuan Anda di hackathon penuh kolaborasi dan
        ...
        <div className="flex">
          ...
          <div>
            <p className="text-sm font-medium text-gray-700 mt-4 px-5">Alamat</p>
            <p className="text-lg text-gray-900 px-5">Jakarta</p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-700 mt-4 px-5">Email</p>
